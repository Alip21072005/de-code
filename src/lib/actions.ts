...
export const createStudent = async (
  ...
  console.log(data);
  try {
    const classItem = await prisma.kelas.findUnique({
...
export const deleteExam = async (
  ...
  try {
    await prisma.tes.delete({
      where: {
        id: parseInt(id),
        // ...(role === "mentor" ? { lesson: { teacherId: userId! } } : {}),
      },
    });
